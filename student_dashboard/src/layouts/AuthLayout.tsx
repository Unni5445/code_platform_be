    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-violet-500 via-purple-500 to-violet-600 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <h2 className="text-3xl font-bold text-white mb-4">Welcome to Skill & Brains</h2>
          <p className="text-white/80 text-lg max-w-sm mx-auto">
            Your gateway to interactive learning. Master coding through hands-on practice and real-world projects.
          </p>
