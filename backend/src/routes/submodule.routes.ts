...
router
  .route("/submodules")
  .post(protect, authorize("ADMIN", "SUPER_ADMIN"), SubmoduleController.createSubmodule);
...
router
  ...
  .put(protect, authorize("ADMIN", "SUPER_ADMIN"), SubmoduleController.updateSubmodule)
